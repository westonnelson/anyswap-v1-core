...
contract AnyswapV6ERC20 is IAnyswapV3ERC20 {
    ...
    bool public immutable underlyingIsMinted;
    ...
    constructor(string memory _name, string memory _symbol, uint8 _decimals, address _underlying, bool _underlyingIsMinted, address _vault) {
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
        underlying = _underlying;
        underlyingIsMinted = _underlyingIsMinted;
